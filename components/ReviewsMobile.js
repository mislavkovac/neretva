		...
		<div>
			...
			<div className="flex flex-col w-[100%]">
				...
				<div
					...
					className="mt-[0.5em] text-center font-sans text-5xl font-extrabold text-[#314455] underline decoration-[#C96567]"
				>
					Product reviews
				</div>
				<div
					style={{ display: showSort || showCategories ? 'none' : 'block' }}
					className="mt-[2em] justify-center align-middle flex flex-row flex-wrap"
				>
					{cards}
				</div>
			</div>
